...
- How closely do your bootstrap CI and CLT CI agree?
  - The two ranges are pretty dang similar. CLT is a *slightly* wider
    range, by about 0.002 on the upper end and 0.0003 on the lower end,
    for my sample size of 5000. This accounts for additional variance
    from the random sampling of the dataset
