...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    ...
    -   At a low population, there are more likely to be fewer samples - this may happen if data collection is proportional to population, or collected in a way that is tied to population.
    -   Fewer samples means that there are less data points to average out and therefore each individual datapoint having more of an influence on the median/mean
...
TBH, these slides are probably a better context for my observations: <https://docs.google.com/presentation/d/1uS7NTo1STrLGv7iQE-cT0DgB6eobSHu7rohDxekZue4/edit?usp=sharing>
