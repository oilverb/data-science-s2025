...
-   What is a range of plausible values, based on the sampling distribution you've generated?
    -   Pi is likely somewhere between 3.1 and 3.15. Its almost definitely more than 3 and less than 3.25. As I submit the assignment, I'm realizing the random values change every time I knit, but that range seems pretty inclusive.
