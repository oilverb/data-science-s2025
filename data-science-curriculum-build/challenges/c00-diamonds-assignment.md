...
- Price increases with carat, but cut accounts for some of the variation
  and outliers.
- At a given value for carat, Ideal cut is generally the most expensive
  and Fair is generally cheapest, but this isn’t a hard and fast rule.
  Especially at larger carat sizes there isn’t a direct relationship
  between these variables.
- Its possible that other variables such as clarity, or specific
  size/shape of the cut might offer more detail.
