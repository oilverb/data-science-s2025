...
diamonds %>%
  ...
  ggplot(aes(carat)) +
  geom_histogram(binwidth = 0.5, boundary = 0.005) +
  scale_x_continuous(
...
A small binwidth of 0.01 shows a high concentration at even numbers of carats - there are peaks at 0.3, 0.4, 0.5, 0.7, 0.9, and 1.0. Its interesting how some even 1/10th carat intervals appear to be skipped.

Increasing the bin size to 0.1 makes it clearer that broadly speaking, there is a peak at 0.3 carats and additional modes around 1.0 and 0.5 ct.

Increasing further to a bin size of 0.5 shows a general trend of a lower quantity at increasing sizes.
