...
**Observations**: - City and highway mpg are generally proportional. High city mpg corresponds to high highway mpg and vice versa. Highway mpg is typically higher than city.
...
**Observations**: - SUVS are most common by a noteable amount. compact, midsize, subcompact, and pickups are all relatively comparable in middling commonness. 2seaters are super rare.
...
**Observations**: - Most SUVs and all pickups are 4WD. I'm suspicious of this dataset. Why aren't we distinguishing 4WD from AWD? As a 2WD pickup truck driver, I feel erased. There is a lot more specific info to look at now, but I don't trust it anymore.
...
**Observations** - Again, I'm feeling erased in my Nissan Frontier :/
