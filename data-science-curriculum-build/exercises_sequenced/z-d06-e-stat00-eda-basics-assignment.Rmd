...
**Observations**: - Ideal is actually most common! Perhaps it has the
...
**Observations**: - Wow, this is unhelpful!. The only notable thing is
that there aren't many high-price Fair quality diamonds.
...
**Observations**: - This is more readable! Ideal is not always the most
pricey; in act it has the lowest median cost. Maybe there are
disproportionately more small-size ideal cut diamonds
...
**Observations**: - This plot seems to support the hypothesis. Looking
at the data for fair cut, there is a much higher average carat size.
Additionally, the ideal cut diamonds are on average, the smallest by
carat, while premium cut is distinctively higher. This suggests that
gemcutters might be taking a small hit in quality for a much larger
size.
