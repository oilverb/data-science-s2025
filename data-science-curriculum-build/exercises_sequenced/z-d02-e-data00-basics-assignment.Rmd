...
-   The majority of diamonds have a high quality cut, but the opposite is true for clarity, where the worst clarity is most common
-   Size ranges from 0.2 to 5.1 carats, but the common values are around 0.75ct, with fairly high concentration around the median/mean
-   In comparison price has a much wider amount of variation, ranging from \$326 to \$18823, with a mean of 3933 and median of 2401. Price has a much stronger skew towards the expensive end, and a wider standard deviation.
