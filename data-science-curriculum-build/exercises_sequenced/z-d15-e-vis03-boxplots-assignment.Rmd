...
**Observations** - Which class tends to be most "middle" for `displ` values? - SUVs, in my opinion

Which plot is more effective for answering the previous question?

The box plot is a lot clearer and easier to read. The overlapping lines on the density plot are confusing to interpret
...
-   Price generally tends to increase with carat

-   Median price increases consistently from 0 to 2.5 carats, but is roughly consistent after that. Max price is fairly consistent from 0.5-1.0 ct and above
