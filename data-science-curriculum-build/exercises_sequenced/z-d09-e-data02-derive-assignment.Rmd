...
-   Why is `cov_diff` so large?
    -   diff represents error in calculated depth, which is generally small. cov_diff is divided by this very small number. Since our calculation is decently accurate cov_diff blows up
...
**Observations**: - Premium is most expensive, followed by fair. There's the highest standard deviation for Premium cut, but generally deviation is higher at better cuts. Price_cov is higher at better cuts, broadly, and is even over 1 for Ideal cuts.
